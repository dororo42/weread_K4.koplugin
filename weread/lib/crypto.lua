...
-- H-5 fix: MD5 round constants hardcoded to avoid cross-platform float
-- precision differences in math.sin() (the K4's C library precision is
-- unverified). Values are floor(abs(sin(i)) * 2^32) for i = 1..64, the
-- standard MD5 K table. Hex style matches sha256_k above.
local md5_k = {

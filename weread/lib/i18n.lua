...
local zh = {
    ...
    ["Bottom of the referencing page (experimental; long notes may flow to the next page)"] = "显示在引用它的当页底部（实验性；长注释可延伸到次页）",
    ["End of each chapter"] = "显示在每章末尾",
    ["This setting only affects new downloads; re-download the book to apply it."] = "该设置仅影响新下载的书；修改后需重新下载已缓存的书才能生效",
    ...
    ["Incomplete download found (%1/%2 chapters done). Resume?"] = "发现未完成的下载（已完成 %1/%2 章），是否继续？",
    ["Resume"] = "继续下载",
    ["Restart"] = "重新下载",

# WeRead KOReader Plugin · K4 分支（v0.6.0-k4-v2.5）
...
基于对 v2.0 的全量代码审查，集中修复了可靠性、数据正确性和性能问题。
...
**代码质量：**
- 所有 KOReader 事件入口（关闭文档/翻页/挂起/恢复）加异常隔离，插件错误不再中断阅读器
- 清理死代码和无效配置项

# WeRead KOReader Plugin · K4 分支（v0.6.0-k4-v4.0）
...
| SQLite 书架库 library_db | 有 | **已移植**（v4.0：书架/详情/目录离线缓存，优雅降级） |
